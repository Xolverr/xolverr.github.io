! function(t) {
    ...
    var $ = function() {
            ...
            return fetch("../preroll/main.min.js", {
                method: "GET",
                headers: {
        ...
        dt = function() {
            ...
            return t.prototype.init = function(n) {
                ...
                if (void 0 === n && (n = {}), "undefined" != typeof window) {
                    ...
                    var X = b("pokiDebug");
                    return X ? (this.setDebug("true" === X), this.debugIsOverwritten = !0) : this.setDebug(A), Promise.all([N(), et(), q("../preroll/main.min.js"), q("../preroll/main.min.js"), R]).catch((function() {
